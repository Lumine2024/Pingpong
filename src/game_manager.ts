import { SceneResetState, sceneController } from "./scene_controller";
import { PlayerBase } from "./player_base";

export class GameManager {
    private leftPlayer: PlayerBase | null;
    private rightPlayer: PlayerBase | null;
    private running: boolean;
    private initialState: SceneResetState | null;
    private readonly gameResultElement: HTMLElement;
    ...
    init(leftPlayer: PlayerBase, rightPlayer: PlayerBase): void {
